...
const UploadWizard = () => {
  ...
  const renderStep = () => {
    switch (currentStep) {
      case 1: return <Step1Upload wizardData={wizardData} updateWizardData={updateWizardData} nextStep={nextStep} />;
      case 2: return <Step2Mapping wizardData={wizardData} updateWizardData={updateWizardData} nextStep={nextStep} prevStep={prevStep} />;
      case 3: return <Step3Preview wizardData={wizardData} updateWizardData={updateWizardData} nextStep={nextStep} prevStep={prevStep} />;
      case 4:
        return (
          <Step4Process
            ...
            onProcessingStart={() => { setHasError(false); setProcessingComplete(false); }}
          />
        );
      default: return null;
    }
